...
class CustomDirectiveSpec extends AnyWordSpec with Matchers {
  ...
  private val FieldDirective = new ast.Directive("field-directive") with OnField

  private val ArgumentDirective = new ast.Directive("arg-directive") with OnArgument

  private val ObjectDirective = new ast.Directive("object-directive") with OnObject

  private val InterfaceDirective = new ast.Directive("interface-directive") with OnInterface
