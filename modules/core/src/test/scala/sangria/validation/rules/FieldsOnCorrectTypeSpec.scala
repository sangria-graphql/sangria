...
class FieldsOnCorrectTypeSpec extends AnyWordSpec with ValidationSupport {
  ...
  "Validate: Fields on correct type" should {
    ...
    "Field not defined on fragment" in expectFails(
      ...
      """,
      List(
        "Cannot query field 'meowVolume' on type 'Dog'. Did you mean 'barkVolume'?" -> Some(
          Pos(3, 11))
      )
    )
    ...
    "Aliased field target not defined" in expectFails(
      ...
      """,
      List(
        "Cannot query field 'mooVolume' on type 'Dog'. Did you mean 'barkVolume'?" -> Some(
          Pos(3, 11))
      )
    )
    ...
    "Aliased lying field target not defined" in expectFails(
      ...
      """,
      List(
        "Cannot query field 'kawVolume' on type 'Dog'. Did you mean 'barkVolume'?" -> Some(
          Pos(3, 11))
      )
    )
    ...
    "Defined on implementors but not on interface" in expectFails(
      ...
      """,
      List(
        "Cannot query field 'nickname' on type 'Pet'. Did you mean to use an inline fragment on 'Cat' or 'Dog'?" -> Some(
          Pos(3, 11))
      )
    )
    ...
    "Defined on implementors queried on union" in expectFails(
      ...
      """,
      List(
        "Cannot query field 'name' on type 'CatOrDog'. Did you mean to use an inline fragment on 'Being', 'Pet', 'Canine', 'Cat' or 'Dog'?" -> Some(
          Pos(3, 11))
      )
    )
  ...
  "Fields on correct type error message" should {
    ...
    "Works with no small numbers of type suggestions" in {
      UndefinedFieldViolation(
        ...
        Nil,
        None,
        Nil).simpleErrorMessage should be(
