        ...
        Document(
          Vector(
            OperationDefinition(
              ...
              Vector(Comment(" test query", None)),
              Vector.empty,
              None
            ),
            FragmentDefinition(
              ...
              Vector.empty,
              Vector.empty,
              Vector(Comment(" field in fragment!", None)),
              None
            )
          ),
          Vector.empty,
        ...
        Document(
          Vector(
            SchemaDefinition(
              Vector(
                OperationTypeDefinition(
                  OperationType.Query,
                  NamedType("QueryType", None),
                  Vector.empty,
                  None),
                OperationTypeDefinition(
                  OperationType.Mutation,
                  NamedType("MutationType", None),
                  Vector.empty,
                  None)
              ),
              Vector.empty,
              ...
              Vector(
                ...
                FieldDefinition(
                  ...
                  Vector(
                    InputValueDefinition(
                      "argument",
                      NotNullType(NamedType("InputType", None), None),
                      None,
                      Vector.empty,
                      None,
                      Vector.empty,
                      None)),
                  Vector.empty,
                  Some(StringValue("another description", false, None, Vector.empty, None)),
                  Vector.empty,
                  None
                ),
                FieldDefinition(
                ...
                FieldDefinition(
                  ...
                  Vector(
                    InputValueDefinition(
                      "argument",
                      NamedType("String", None),
                      Some(StringValue("string", false, None, Vector.empty, None)),
                      Vector.empty,
                      None,
                      Vector.empty,
                      None)),
                ...
                FieldDefinition(
                  ...
                  Vector(InputValueDefinition(
                    "argument",
                    ListType(NamedType("String", None), None),
                    Some(
                      ListValue(
                        Vector(
            ...
            InterfaceTypeDefinition(
              ...
              Vector.empty,
              None,
              Vector(Comment(" It's an interface!", None)),
              Vector.empty,
              None
            ),
            InterfaceTypeDefinition(
            ...
            UnionTypeDefinition(
              "AnnotatedUnion",
              Vector(NamedType("A", None), NamedType("B", None)),
              Vector(
                Directive(
                  "onUnion",
                  Vector.empty,
            ...
            EnumTypeDefinition(
              ...
              Vector(
                EnumValueDefinition(
                  ...
                  Vector.empty,
                  None,
                  Vector(Comment(" value 1", None)),
                  None),
                EnumValueDefinition(
                  "MOBILE",
                  Vector.empty,
                  None,
                  Vector(Comment(" value 2", None)),
                  None)
              ),
              Vector.empty,
              None,
            ...
            InputObjectTypeDefinition(
              ...
              Vector(
                InputValueDefinition(
                  "key",
                  NotNullType(NamedType("String", None), None),
                  None,
                  Vector.empty,
                  None,
                  Vector.empty,
                ...
                InputValueDefinition(
                  "answer",
                  NamedType("Int", None),
                  Some(BigIntValue(42, Vector.empty, None)),
                  Vector.empty,
                  None,
                  Vector.empty,
                  None)
            ...
            InputObjectTypeDefinition(
              ...
              Vector(InputValueDefinition(
                ...
                None,
                Vector(Comment(" field comment", None)),
                None
              )),
              Vector(
                Directive(
            ...
            DirectiveDefinition(
              ...
              Vector(
                InputValueDefinition(
                  "if",
                  NotNullType(NamedType("Boolean", None), None),
                  None,
                  Vector.empty,
                  None,
                  Vector.empty,
        ...
        ObjectValue(
          Vector(
            ...
            ObjectField(
              ...
              Vector(Comment(" test comment", Some(AstLocation(40, 5, 11)))),
