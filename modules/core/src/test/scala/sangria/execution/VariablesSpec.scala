...
import sangria.util.{GraphQlSupport, Pos}
    ...
    fields[Unit, Unit](
      Field(
        ...
        resolve = ctx =>
          ctx
            .argOpt[Any]("input")
            .map(DefaultValueRenderer
              .renderCoercedInputValueCompact(_, OptionInputType(TestInputObject)))
      ),
      Field(
        ...
        resolve = ctx =>
          ctx
            .argOpt[Any]("input")
            .map(
              DefaultValueRenderer.renderCoercedInputValueCompact(_, OptionInputType(StringType)))
      ),
      Field(
      ...
      Field(
        ...
        resolve = ctx =>
          DefaultValueRenderer.renderCoercedInputValueCompact(ctx.arg[Any]("input"), StringType)
      ),
      Field(
        ...
        resolve = ctx =>
          ctx
            ...
            .map(
              DefaultValueRenderer.renderCoercedInputValueCompact(
                _,
                OptionInputType(ListInputType(OptionInputType(StringType)))))
      ),
      Field(
        "nnList",
        OptionType(StringType),
        ...
        resolve = ctx =>
          DefaultValueRenderer.renderCoercedInputValueCompact(
            ctx.arg[Any]("input"),
            ListInputType(OptionInputType(StringType)))
      ),
      Field(
        "listNN",
        OptionType(StringType),
        ...
        resolve = ctx =>
          ctx
            .argOpt[Any]("input")
            .map(DefaultValueRenderer
              .renderCoercedInputValueCompact(_, OptionInputType(ListInputType(StringType))))
      ),
      Field(
        "nnListNN",
        OptionType(StringType),
    ...
    "Handles objects and nullability" when {
      "using inline structs" when {
        ...
        "executes with complex input containing undefined object fields" in check(
          ...
          """,
          Map("data" -> Map("fieldWithObjectInput" -> """{b:["bar"],c:"baz"}"""))
        )
        ...
        "properly coerces single value to array" in check(
          ...
          """,
          Map("data" -> Map("fieldWithObjectInput" -> """{a:"foo",b:["bar"],c:"baz"}"""))
        )
        ...
        "properly parses null value to null" in check(
          ...
          """,
          Map("data" -> Map("fieldWithObjectInput" -> """{a:null,b:null,c:"C",d:null}"""))
        )
        ...
        "properly parses null value in list" in check(
          ...
          """,
          Map("data" -> Map("fieldWithObjectInput" -> """{b:["A",null,"C"],c:"C"}"""))
        )
