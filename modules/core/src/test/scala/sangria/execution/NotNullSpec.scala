  ...
  "Execute: handles non-nullable types" should {
    ...
    "nulls a complex tree of nullable fields that throw" in checkErrors(
      ...
      List(
        ...
        Map(
          "message" -> "sync",
          "path" -> List("nest", "nest", "sync"),
          "locations" -> List(Map("line" -> 7, "column" -> 15))),
        Map(
          "message" -> "sync",
          "path" -> List("nest", "promiseNest", "sync"),
          "locations" -> List(Map("line" -> 11, "column" -> 15))),
        Map(
          "message" -> "sync",
          "path" -> List("promiseNest", "sync"),
          "locations" -> List(Map("line" -> 16, "column" -> 13))),
        Map(
          "message" -> "sync",
          "path" -> List("promiseNest", "nest", "sync"),
          "locations" -> List(Map("line" -> 19, "column" -> 15))),
        Map(
          "message" -> "sync",
          "path" -> List("promiseNest", "promiseNest", "sync"),
          "locations" -> List(Map("line" -> 23, "column" -> 15))),
        Map(
          "message" -> "promise",
          "path" -> List("nest", "promise"),
          "locations" -> List(Map("line" -> 5, "column" -> 13))),
        Map(
          "message" -> "promise",
          "path" -> List("nest", "nest", "promise"),
          "locations" -> List(Map("line" -> 8, "column" -> 15))),
        Map(
          "message" -> "promise",
          "path" -> List("nest", "promiseNest", "promise"),
          "locations" -> List(Map("line" -> 12, "column" -> 15))),
        Map(
          "message" -> "promise",
          "path" -> List("promiseNest", "promise"),
          "locations" -> List(Map("line" -> 17, "column" -> 13))),
        Map(
          "message" -> "promise",
          "path" -> List("promiseNest", "nest", "promise"),
          "locations" -> List(Map("line" -> 20, "column" -> 15))),
        Map(
          "message" -> "promise",
          "path" -> List("promiseNest", "promiseNest", "promise"),
          "locations" -> List(Map("line" -> 24, "column" -> 15)))
      )
    )
    ...
    "nulls the top level if sync non-nullable field throws" in check(
      ...
      Map(
        ...
        "errors" -> List(
          Map(
            "message" -> "nonNullSync",
            "path" -> List("nonNullSync"),
            "locations" -> List(Map("line" -> 1, "column" -> 11)))))
    )
    ...
    "Handles non-null argument" should {
      ...
      val schemaWithNonNullArg = Schema(
        ObjectType(
          "Query",
          fields[Unit, Unit](
            Field(
      ...
      "succeeds when passed non-null literal value" in SimpleGraphQlSupport.check(
      ...
      "succeeds when missing variable has default value" in SimpleGraphQlSupport.check(
        schemaWithNonNullArg,
        (),
        """
      ...
      "field error when missing non-null arg" in SimpleGraphQlSupport.check(
        schemaWithNonNullArg,
        (),
        """
          query {
      ...
      "field error when non-null arg provided null" in SimpleGraphQlSupport.check(
        schemaWithNonNullArg,
        (),
        """
          query {
      ...
      "field error when non-null arg not provided variable value" in SimpleGraphQlSupport.check(
        schemaWithNonNullArg,
        (),
        """
          query ($testVar: String) {
      ...
      "field error when non-null arg provided variable with explicit null value" in SimpleGraphQlSupport
        .check(
          schemaWithNonNullArg,
          (),
          """
