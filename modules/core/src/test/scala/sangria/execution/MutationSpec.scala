...
class MutationSpec extends AnyWordSpec with Matchers with GraphQlSupport {
  ...
  val NumberHolderType = ObjectType(
    "NumberHolder",
    fields[UserContext, NumberHolder](
      ...
      ObjectType(
        ...
        fields[UserContext, Root](
          Field(
            ...
            resolve = ctx =>
              UpdateCtx(ctx.value.immediatelyChangeTheNumber(ctx.arg(NewNumberArg)))(v =>
                ctx.ctx.copy(num = ctx.ctx.num + v.theNumber.get()))
          ),
          Field(
            "deferChangeTheNumber",
            OptionType(NumberHolderType),
            arguments = NewNumberArg :: Nil,
            resolve = ctx =>
              UpdateCtx(
          ...
          Field(
            "deferFailChangeTheNumber",
            OptionType(NumberHolderType),
            arguments = NewNumberArg :: Nil,
            resolve = ctx =>
              UpdateCtx(FailedDefer(ctx.value.immediatelyChangeTheNumber(ctx.arg(NewNumberArg))))(
                v => ctx.ctx.copy(num = ctx.ctx.num + v.theNumber.get()))
          ),
          Field(
            "deferFutChangeTheNumber",
            OptionType(NumberHolderType),
            arguments = NewNumberArg :: Nil,
            resolve = ctx =>
          ...
          Field(
            ...
            arguments = NewNumberArg :: Nil,
            resolve = ctx =>
              UpdateCtx(ctx.value.promiseToChangeTheNumber(ctx.arg(NewNumberArg)))(v =>
                ctx.ctx.copy(num = ctx.ctx.num + v.theNumber.get()))
          ),
          Field(
            ...
            arguments = NewNumberArg :: Nil,
            resolve = ctx =>
              UpdateCtx(ctx.value.failToChangeTheNumber(ctx.arg(NewNumberArg)))(v =>
                ctx.ctx.copy(num = ctx.ctx.num + v.theNumber.get()))
          ),
          Field(
            ...
            arguments = NewNumberArg :: Nil,
            resolve = ctx =>
              UpdateCtx(ctx.value.promiseAndFailToChangeTheNumber(ctx.arg(NewNumberArg)))(v =>
                ctx.ctx.copy(num = ctx.ctx.num + v.theNumber.get()))
          )
        )
      ))
  ...
  "Execute: Handles mutation execution ordering" should {
    "evaluates mutations serially" in check(
      ...
      Map(
        "data" -> Map(
          "first" -> Map("theNumber" -> 1, "userCtx" -> 11),
          "second" -> Map("theNumber" -> 2, "userCtx" -> 13),
          "third" -> Map("theNumber" -> 3, "userCtx" -> 16),
          "fourth" -> Map("theNumber" -> 4, "userCtx" -> 20),
          "fifth" -> Map("theNumber" -> 5, "userCtx" -> 25),
          "def" -> Map("theNumber" -> 6, "userCtx" -> 31),
          "defFut" -> Map("theNumber" -> 7, "userCtx" -> 38)
        )
      ),
    ...
    "evaluates mutations correctly in the presence of a failed mutation" in checkErrors(
      ...
      Map(
        ...
        "second" -> Map("theNumber" -> 2, "userCtx" -> 13),
        "third" -> null,
        "fourth" -> Map("theNumber" -> 4, "userCtx" -> 17),
        "fifth" -> Map("theNumber" -> 5, "userCtx" -> 22),
        "sixth" -> null,
        "def" -> Map("theNumber" -> 7, "userCtx" -> 29),
        "defFail" -> null,
        "defFut" -> Map("theNumber" -> 9, "userCtx" -> 38),
        "defFutFail" -> null,
        "def1" -> Map("theNumber" -> 11, "userCtx" -> 49)
      ),
      List(
        Map(
      ...
      val mutation = ObjectType(
        ...
        fields[String, Unit](
          Field(
            ...
            resolve =
              c => UpdateCtx(c.ctx + " " + c.arg(AddArg))(v => v + " ctx ").map(v => v + " map")),
          Field(
            "updateFuture",
            child,
            arguments = AddArg :: Nil,
