...
class Json4sJacksonSupportSpec extends WordSpec with Matchers with AwaitSupport {
  "Json4sJacksonSupport" should {
    ...
    "correctly serialize" in {
      ...
      Json4sJacksonResultMarshaller.arrayNode(Vector(JString("aa"), JInt(11))) should be (JArray(JString("aa") :: JInt(11) :: Nil))
      ...
      Json4sJacksonResultMarshaller.addMapNodeElem(JObject("aa" → JString("bb")), "cc", JInt(321), false) should be (
